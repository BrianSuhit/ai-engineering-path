A nivel arquitectónico, un *pipeline* seguro asume que el usuario siempre va a intentar romper el sistema. Por lo tanto, interceptamos su mensaje antes de enviarlo, lo sanitizamos, y luego blindamos la puerta de salida para que el modelo no pueda responder con texto libre, sino que deba encajar su respuesta en nuestro molde estructurado.
<br><br>
Acá tenés la implementación completa utilizando el SDK moderno de Google:
<br><br>
